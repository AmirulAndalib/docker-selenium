...
![Version: 0.46.0](https://img.shields.io/badge/Version-0.46.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 4.35.0-20250808](https://img.shields.io/badge/AppVersion-4.35.0--20250808-informational?style=flat-square)
...
| https://prometheus-community.github.io/helm-charts | kube-prometheus-stack | ^76.0.0 |
...
| global.seleniumGrid.imageTag | string | `"4.35.0-20250808"` | Image tag for all selenium components |
| global.seleniumGrid.nodesImageTag | string | `"4.35.0-20250808"` | Image tag for browser's nodes |
| global.seleniumGrid.videoImageTag | string | `"ffmpeg-7.1-20250808"` | Image tag for browser's video recorder |
