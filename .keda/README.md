...
```bash
docker pull selenium/keda:2.17.2-selenium-grid-20250707
docker pull selenium/keda-metrics-apiserver:2.17.2-selenium-grid-20250707
docker pull selenium/keda-admission-webhooks:2.17.2-selenium-grid-20250707
```
...
```yaml
  image:
    keda:
      registry: selenium
      repository: keda
      tag: "2.17.2-selenium-grid-20250707"
    metricsApiServer:
      registry: selenium
